...
var Web3Client = /** @class */ (function () {
    function Web3Client(provider, options) {
        this.web3 = new web3_1.default(provider);
        this.options = options;
    }
    Web3Client.prototype.deploy = function (abi, bytecode, args) {
        var _this = this;
    ...
    Web3Client.prototype.transaction = function (abi, address, method, args) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var _a;
            var contract = new _this.web3.eth.Contract(abi, address);
            (_a = contract.methods)[method].apply(_a, args).send(_this.options)
                .on('transactionHash', function (transactionHash) {
                resolve(transactionHash);
            })
                .catch(reject);
    ...
    Web3Client.prototype.isConfirmed = function (txHash, blocks) {
